...
public class DispensadorEfectivo
{
   // el n�mero inicial predeterminado de billetes en el dispensador de efectivo
    private final static int B100=2000;
    private final static int B200=1500;
    private final static int B500=1000;
   private final static int CUENTA_INICIAL = B100*5+B200*10+B500*25;
   ...
   public boolean EfectivoDisponible( int monto ){
      int billetesRequeridos = monto / 20; // n�mero de billetes de $20 requeridos
   ...
   public void ingresarCuenta(int monto){
       cuenta=monto;
   }
